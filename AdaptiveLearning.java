 ...
 */
@WebServlet(name = "AdaptiveLearning", urlPatterns = {"/AdaptiveLearning"})
public class AdaptiveLearning extends HttpServlet {
...
//            jTextArea1.append("Confusion Matrix : "+eval.toMatrixString());
            String data3=eval.toSummaryString("\nResults\n----------\n",true)+" "+"F-Measure Score : "+eval.fMeasure(1)+"\n"+"Precision Score : "+eval.precision(1)+"\n"+"Recall Score : "+eval.recall(1)+"\n"+"Confusion Matrix : "+eval.toMatrixString();
            System.out.println(eval.toSummaryString("\nResults\n----------\n",true));
            System.out.println(eval.fMeasure(1)+" "+eval.precision(1)+" "+eval.recall(1));
            request.setAttribute("sans3", data3);
        RequestDispatcher view = request.getRequestDispatcher("AdaptiveLearning.jsp");
